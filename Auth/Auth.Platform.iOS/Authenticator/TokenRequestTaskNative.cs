    ...
    public class TokenRequestTaskNative
    {
        ...
        public async Task<TokenResponse> RequestAsync()
        {
            ...
            try
            {
                ...
                TokenResponse resp = new TokenResponse(tokenRequest, (NSDictionary<NSString, NSCopying>)NSJsonSerialization.Deserialize(NSData.FromString(json.ToString()), 0, out nsError));
